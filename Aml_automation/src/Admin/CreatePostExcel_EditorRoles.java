	...
	public class CreatePostExcel_EditorRoles {
		...
		public void createPost(String posttype, String posttitle, String postcontent, String primaryimage,
			...
			if (Run.trim().equalsIgnoreCase("Y")) {
				 ...
				 * ; if(arrlogin!=null) { String[]
				 * logintypes=arrlogin.split("@##@"); blogrole= logintypes[1];
				 * if(blogrole==null) { blogrole="Admin"; }
				...
				else if((blogrole.equalsIgnoreCase("Branded Coordinator") || blogrole.equalsIgnoreCase("Branded Collaborator")) && posttype.contains("Branded"))
				{
				...
				else if((blogrole.equalsIgnoreCase("Coordinator") || blogrole.equalsIgnoreCase("Collaborator") || blogrole.equalsIgnoreCase("Editor") || blogrole.equalsIgnoreCase("Lead Editor") || blogrole.equalsIgnoreCase("Editor Senior")) && (!posttype.contains("Branded")))
				{
					...
					status=true;
						...
						System.out.println(blogrole + " : " + "You are not authorised to click on the link as excel file does not match your data");
						status=false;
		...
		if( status==true)
		{
				 ...
				 * System.out.
				 * println("Branded Collaborator don't have access to publish a post"
				 * ); } else{
				 */
