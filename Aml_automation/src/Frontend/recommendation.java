...
public class recommendation {
	...
	public void getPostTitle() {
		...
		list.add(frontendProperties.findElement(prop.getProperty("post_title"))
				.getText());
	}
	...
	public void GetSideRecommendation() {
		...
		List<WebElement> siderecom = frontendProperties
				.findElementsByXpath(prop.getProperty("side_recommendations"));
	...
	public void getBottomRecommendation() {
		List<WebElement> bottomrecom = frontendProperties
				.findElementsByXpath(prop.getProperty("bottom_recommendations"));
	...
	public void getDuplicateRecommendations() throws IOException {
		...
		System.out.println("Duplicate Recommendations : "
				+ frontendProperties.findDuplicates(list));
